...
const radios = document.getElementsByName('finger'); // Assuming all radios share the name 'input'
let inputValue = 0;

// Loop to find the selected radio button
radios.forEach(radio => {
  if (radio.checked) {
    inputValue = parseInt(radio.value, 10); // Convert the value to an integer
  }
});
